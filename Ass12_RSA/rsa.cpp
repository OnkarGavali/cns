...
int main() {
    ...
    msg = msg % n;
    cout<<"The input message is (taking mod) "<<msg<<"\n";

    long long c = power(msg,e,n);
    cout<<"The ciphered text is power(msg,e,n): "<<c<<"\n";
    
    long long org = power(c,d,n);
    cout<<"The original message is power(c,d,n): "<<org<<"\n";
